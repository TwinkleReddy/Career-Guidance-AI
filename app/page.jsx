    ...
    <div>
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 gradient-background">
        <div className="container mx-auto px-4 md:px-6">
          <h2 className="text-3xl font-bond text-center text-tighter mb-12">Powerful Features for Your Career Growth</h2>
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 gradient-background">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-3xl font-bond mb-4">How it Works</h2>
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 bg-background/30">
        <div className="container mx-auto px-4 md:px-6">
          <h2 className="text-3xl font-bond text-center text-tighter mb-12">What Our Users Say</h2>
      ...
      <section className="w-full py-12 md:py-24 lg:py-32 gradient-background">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center max-w-3xl mx-auto mb-12">
            <h2 className="text-3xl font-bond mb-4">Frequently Asked Questions</h2>
            <p className="text-muted-foreground">
      ...
      <section className="w-full">
        <div className="mx-auto py-24 gradient rounded-lg">
          <div className="flex flex-col items-center justify-center space-y-4 text-center max-w-3xl mx-auto">
            ...
            <Link href='/dashboard'>
              <Button size='lg' className='h-11 mt-5 animate-bounce bg-black text-white' variant='primary'>
